          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                {errors.firstName && (
                  <p className="mt-1 text-sm text-red-600 font-inter">{errors.firstName.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.lastName && (
                  <p className="mt-1 text-sm text-red-600 font-inter">{errors.lastName.message}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="mt-1 text-sm text-red-600 font-inter">{errors.confirmPassword.message}</p>
              )}
            </div>
